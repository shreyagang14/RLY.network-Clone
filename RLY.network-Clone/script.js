...
page2btn()
function page2alpha(){
    document.querySelector("#alpha1>button")
    .addEventListener("mouseover",function(){
       
        document.querySelector("#alpha1>button>#btex>h3:nth-child(1)").style.transform = `translateY(-100%)`
        document.querySelector("#alpha1>button>#btex>h3:nth-child(2)").style.transform = `translateY(-100%)`
        cursor.style.display = "none"
    ...
    .addEventListener("mouseleave",function(){
        ...
        document.querySelector("#alpha1>button>#btex>h3:nth-child(1)").style.transform = `translateY(0%)`
        document.querySelector("#alpha1>button>#btex>h3:nth-child(2)").style.transform = `translateY(0%)`
        cursor.style.display = "block"
    ...
    document.querySelector("#alpha1>button")
    .addEventListener("mouseover",function(dets){
var dim = document.querySelector("#alpha1>button>#green").getBoundingClientRect()
        document.querySelector("#alpha1>button>#green").style.clipPath = `circle(150% at ${dets.clientX - dim.left}px ${dets.clientY - dim.top}px)`
    })
    document.querySelector("#alpha1>button")
    .addEventListener("mouseleave",function(dets){
var dim = document.querySelector("#alpha1>button>#green").getBoundingClientRect()
        document.querySelector("#alpha1>button>#green").style.clipPath = `circle(0% at ${dets.clientX - dim.left}px ${dets.clientY - dim.top}px)`
    })
}
page2alpha()
